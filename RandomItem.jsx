...
export default function RandomItem(props) {
    return(
        ...
        <div onClick={()=>props.func(props.id, props.title, props.subtitle, props.description, props.imgurl, props.decade)} className="ran-item" style={props.randomItemStyles}>
